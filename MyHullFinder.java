...
/**
 * An implementation of an incremental convex-hull
 * implemented with a CircularTree. Be certain that
 * your running times match those specified in the
...
public class MyHullFinder implements ConvexHullFinder {
	...
	/**
	 * Set up and initialize the instance variables, adding new ones at the
	 * top of the file if necessary or desired.
	 */
	...
	public MyHullFinder(String imagePath) {
		/*
         * Note: Any time a CircularTree<Angle, HullPoint> is instantiated, it must use a new
         * AngleComparator, or else it will use a default comparator that doesn't understand how
         * our angles work.
         */
...
/**
	 ...
	 * <code>ConvexHull</code> should decide if the new vertex should be on
	 * the hull or not. If the new point is on the hull, the
	 * <code>ConvexHull</code> should add it to the hull and then adjust the
	 ...
	 * this problem.
	 *
	 * ANOTHER WARNING: Note that (0,0) is the top left corner of the panel, meaning that
	 * lower points have a higher y value.  Take this into account when making angles.
	 *
	 * <p>Do not call this method explicitly! The visualizer does this!
	 *
	 * @param vertex the newly created vertex resulting from a user click
	 */
	...
	/**
	 * When the user clicks on the "Clear" button, the <code>HullVisualizer</code>
	...
	*/
	...
	/**
	 * When the "Solve" button is clicked this method is called to
	 * invoke a static graham scan.
	 *
	 * Note: It is probably a good idea to 'sort' the points by angle
	 * using some sort of data structure that uses keys to keep track of the minimum.
	 *
	 */
	 ...
	 * rest of your code. Writing helper methods instead of 
	 * copying and pasting helps "segment" your code, makes 
	 * it easier to understand, and avoids problems in keeping 
	 * each occurance "up-to-date."
	 */ 
